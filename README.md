...
![Ground Truth Example 1|400x200](assets/groundtruth-1.gif)
![Ground Truth Example 2|400x200](assets/groundtruth-2.gif)
![Ground Truth Example 3|400x200](assets/groundtruth-3.gif)
...
The combination of neural cellular automata with learned latent spaces suggests a broader paradigm: compact, local update rules that are themselves generated by a learned model, producing an open-ended family of emergent systems from a single trained network.
